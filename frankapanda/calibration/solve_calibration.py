...
if __name__ == "__main__":
    ...
    cam_id = 3
    data_dirname = "/data/robogen/RoboGen-sim2real/real_world/pcd_obs_env_bowen/calibration/data"
    ...
    calib_dirname = os.path.join("/data/robogen/RoboGen-sim2real/real_world/pcd_obs_env_bowen/calibration", "calibration_results")
